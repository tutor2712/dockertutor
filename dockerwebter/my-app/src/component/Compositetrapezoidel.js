            ...
            <div>
                ...
                <h3>numer</h3>
                       ...
                       <div><h3>range :</h3></div>
                        ...
                        <br/>
                        <button onClick = {this.CompositeTrapezoidalRule}> click </button>
                        <br/>
                      <h3>database </h3>
                     <button onClick = {this.CompositeTrapezoidalRule}> fx : {window.$fx} <br/> range : {window.$range} <br/> start : {window.$start} <br/> stop : {window.$stop}</button>
